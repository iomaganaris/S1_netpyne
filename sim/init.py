...
sim.analysis.plotTraces(include=cfg.recordCells, timeRange=[0,cfg.duration], overlay=True, oneFigPer='cell', ylim=[-100,40], axis=False, scaleBarLoc=2, figSize=(12, 4), fontSize=7, saveFig=True)
...
sim.analysis.plotTraces(include=cfg.recordCells, timeRange=[0,cfg.duration], overlay=False, oneFigPer='trace', ylim=[-100,40], axis=False, scaleBarLoc=2, figSize=(18, 12), fontSize=9, saveFig=True)
